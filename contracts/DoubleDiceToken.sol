...
{ 
    ...
    /// @dev The state for an account is stored in this mapping in conjuction with
    ...
    /// - either one of the two parties involved in a `transfer` or `transferFrom`,
    /// - or was explicitly excluded from a `distributeYield`,
